...
describe('UserSignupPage', () => {
  ...
  describe('Interactions', () => {
    ...
    // use mockImplemtation to return response with delay
    ...
    // this function is used for signup test cases
    const setupForSubmit = (props) => {
      // assign render result into an object
    ...
    it('calls postSignup when the fields are valid and the actions are provied in props', () => {
      const actions = {
    ...
    it('hides the spinner after api call finishes successfully', async () => {
      const actions = {
        postSignup: mockAsyncDelayed(),
      };
      const { queryByText } = setupForSubmit({ actions });
